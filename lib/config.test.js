...
describe('Configurator', () => {
  ...
  describe('without environment variables', () => {
    let prevGrUrl = null
    let prevGrToken = null

    beforeEach(() => {
      prevGrUrl = process.env.GLOBAL_REGISTRY_URL
      prevGrToken = process.env.GLOBAL_REGISTRY_TOKEN
      delete process.env.GLOBAL_REGISTRY_URL
      delete process.env.GLOBAL_REGISTRY_TOKEN
    })

    afterEach(() => {
      process.env.GLOBAL_REGISTRY_URL = prevGrUrl
      process.env.GLOBAL_REGISTRY_TOKEN = prevGrToken
    })
